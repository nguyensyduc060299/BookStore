            ...
            <div class="row-style-1">
                ...
                <div class="content-right">
                    ...
                    <div class="account-profile register-form">
                        <form:form action="${pageContext.request.contextPath }/admin/category-manage/add"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">
                                    <form:input path="name" class="form-control" id="full_name" placeholder="Tên thể loại muốn thêm"></form:input>
